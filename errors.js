...
function main() {
  ...
  do {
    ...
    console.log("2. Lägg till vara och pris"); // utf-8 .. går att lägga till men blir error på åäö och därefter går det ej att söka.
    console.log("3. Ta bort vara (inte implementerad!)");
    console.log("4. Sök vara"); // hittar inte varor [LÖST]
    console.log("5. Visa dyraste/billigaste vara (inte implementerad!)");
    console.log("6. Visa totalkostnad"); //visar bara priset på sista varan [LÖST]
    console.log("7. Visa medelkostnaden per vara (inte implementerad!)"); //saknade break. gick direkt över till 8an och raderade hela listan. [LÖST]
    console.log("8. Töm listan");
    console.log("9. Avsluta"); // avslutar inte alltid
